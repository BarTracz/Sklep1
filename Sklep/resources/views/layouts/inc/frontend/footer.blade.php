<footer class="bg-light.bg-gradient text-dark pt-5 pb-4">
    <div class="container text-center tex-md-left">
        <div class="row text-center text-md-left">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p class="text-dark">
                    <i class=" fa fa-envelope mr-3"></i> info@xdkom.com
                </p>
                <p class="text-dark">
                    <i class="fa fa-phone mr-3"></i> +48 123456789
                </p>
                <p class="text-dark">
                    <i class="fa fa-print mr-3"></i> +92 987654321
                </p>
            </div>
                ...
                <div class="col-md-5 col-lg-4">
                    <div class="text-center text-md-right">
                        ...
                        <li class="list-inline-item">
                            <a href="#" class="btn-floating btn-sm text-dark" style="font-size: 23px;"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li class="list-inline-item">
                        ...
                        <li class="list-inline-item">
                            <a href="#" class="btn-floating btn-sm text-dark" style="font-size: 23px;"><i class="fa fa-linkedin"></i></a>
                        </li>
                </div>
