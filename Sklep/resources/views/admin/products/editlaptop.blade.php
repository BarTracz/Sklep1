                    ...
                    <div id="details">
                        '<div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label>CPU</label>
                                    <input type="text" name="cpu" value="<?php {
                                                                                echo $product->Laptop->cpu;
                                                                            } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label>GPU</label>
                                    <input type="text" name="gpu" value="<?php {
                                                                                echo $product->Laptop->gpu;
                                                                            } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ram_type" value="<?php {
                                                                                    echo $product->Laptop->ram_type;
                                                                                } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="disk1_type" value="<?php {
                                                                                    echo $product->Laptop->disk1_type;
                                                                                } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="disk1_size" value="<?php {
                                                                                        echo $product->Laptop->disk1_size;
                                                                                    } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="disk2_type" value="<?php {
                                                                                    echo $product->Laptop->disk2_type;
                                                                                } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="disk2_size" value="<?php {
                                                                                        echo $product->Laptop->disk2_size;
                                                                                    } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="display_size" value="<?php {
                                                                                        echo $product->Laptop->display_size;
