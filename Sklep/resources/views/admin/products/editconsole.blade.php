                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="disk_size" value="<?php {
                                                                                        echo $product->Console->disk_size;
                                                                                    } ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="controller_number" value="<?php {
                                                                                                echo $product->Console->controller_number;
                                                                                            } ?>" class="form-control" />
                                </div>
                            </div>
                        </div>
